    ...
    for i in range(len(fastqs)):
        if fastqs[i] != '':
            ...
            for rr, pair in enumerate(sample):
                ...
                cmd = 'STAR --chimSegmentMin 2 --outFilterMismatchNmax 3 --readFilesCommand "gunzip -c" --alignEndsType EndToEnd --runThreadN 4 --outSAMstrandField intronMotif --outSAMtype BAM SortedByCoordinate ';
